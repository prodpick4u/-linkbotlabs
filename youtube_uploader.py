...
import json
import google.auth
from google_auth_oauthlib.flow import InstalledAppFlowimport os
import json
import google.auth
...
# ✅ This must be outside the function with no indentation
if __name__ == "__main__":
    video_url = upload_video(
        video_path="your_video.mp4",  # ⬅️ Replace with your actual filename
...
# ✅ MAKE SURE THIS BLOCK IS NOT INDENTED!
if __name__ == "__main__":
    video_url = upload_video(
        video_path="your_video.mp4",  # ⬅️ Make sure this matches your actual video filename
        title="Automated Test Upload",
        description="Uploaded using YouTube API and Python"
    )
    print("✅ Uploaded! Video URL:", video_url)
